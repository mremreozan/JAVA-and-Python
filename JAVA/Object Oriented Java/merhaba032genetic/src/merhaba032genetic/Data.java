...
import merhaba032genetic.domain.Course;
import merhaba032genetic.domain.Department;
import merhaba032genetic.domain.Instructor;
import merhaba032genetic.domain.Room;
import merhaba032genetic.domain.MeetingTime;
...
public class Data {
	...
	private Data initialize() {
		...
		MeetingTime meetingTime1 = new MeetingTime ("MT1", "MWF 09:00 - 10:30");
		...
		Instructor instructor1 = new Instructor ("I1", "james");
		Instructor instructor2 = new Instructor ("I2", "mike");
		Instructor instructor3 = new Instructor ("I3", "steve");
		Instructor instructor4 = new Instructor ("I4", "jane");
