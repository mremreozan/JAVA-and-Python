 ...
 * This class allows to check if the assignment is consistent with some constraints, 
 * if it is complete (all variables are assigned), or if it is solution for a given CSP. 
 */
public class Assignment {
    ...
    /**
     * class variables to their assigned values.
     */
    ...
    /**
     * Returns true if this assignment does not violate any constraints of <code>constraints</code>.
     */
