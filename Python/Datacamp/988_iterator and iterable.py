# -*- coding: utf-8 -*-
"""
Created on Tue Mar 10 21:09:21 2020
...
# CAUTION, flash is an iterable and superhero is an iterator.
...
for index2, value2 in enumerate(mutants, 10):
    print(index2, value2)
...
# Re-create a zip object from mutants and powers: z1
    # Because the previous print() call would have exhausted 
    # the elements in z1, recreate the zip object you defined 
    # earlier and assign the result again to z1.
z1 = zip(mutants, powers)
